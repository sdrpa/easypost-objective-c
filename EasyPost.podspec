#
#  Be sure to run `pod spec lint EasyPost.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Sinisa Drpa"
  # s.authors            = { "Sinisa Drpa" => "sdrpa@tagtaxa.com" }
  ...
  #s.source       = { :git => "http://EXAMPLE/EasyPost.git", :tag => "0.0.1" }
  ...
  s.public_header_files = "EasyPost/**/*.h"
